...
import { DwarfRcJson, FileType, IDE } from "../..";
import { joinPathsToUri } from "../../util/uri";

export async function getWorkspaceRcConfigs(ide: IDE): Promise<DwarfRcJson[]> {
  try {
    ...
    return rcFiles
      .flat()
      .map((file) => JSONC.parse(file) as unknown as DwarfRcJson);
  } catch (e) {
