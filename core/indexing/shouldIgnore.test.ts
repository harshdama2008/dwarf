...
describe("shouldIgnore", () => {
  ...
  test("should return true if a folder is ignored by .dwarfignore", async () => {
    addToTestDir([
      ["ignored-folder/file.txt", "content"],
      [".dwarfignore", "ignored-folder/"],
    ]);
  ...
  test("should return true if a .dwarfignore override ignores file", async () => {
    addToTestDir([
      ["override-file.txt", "content"],
      [".gitignore", "override-file.txt"],
      [".dwarfignore", "!override-file.txt"],
    ]);
    const result = await shouldIgnore(
  ...
  test("should return true for deeply nested file ignored by ignore files at multiple levels", async () => {
    addToTestDir([
      ...
      ["level1/level2/.dwarfignore", "level3/"],
    ]);
    const result = await shouldIgnore(
