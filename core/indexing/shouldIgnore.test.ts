...
describe("shouldIgnore", () => {
  ...
  test("should return true if a folder is ignored by .mangoignore", async () => {
    addToTestDir([
      ["ignored-folder/file.txt", "content"],
      [".mangoignore", "ignored-folder/"],
    ]);
  ...
  test("should return true if a .mangoignore override ignores file", async () => {
    addToTestDir([
      ["override-file.txt", "content"],
      [".gitignore", "override-file.txt"],
      [".mangoignore", "!override-file.txt"],
    ]);
    const result = await shouldIgnore(
  ...
  test("should return true for deeply nested file ignored by ignore files at multiple levels", async () => {
    addToTestDir([
      ...
      ["level1/level2/.mangoignore", "level3/"],
    ]);
    const result = await shouldIgnore(
