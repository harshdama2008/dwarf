...
export class DwarfCompletionProvider
  implements vscode.InlineCompletionItemProvider
{
  private async onError(e: unknown) {
    ...
    let message = "Dwarf Autocomplete Error";
    ...
    try {
      ...
      const autocompleteCompletionItem = new vscode.InlineCompletionItem(
        ...
        range,
        {
          ...
          command: "dwarf.logAutocompleteOutcome",
      ...
      if (isFim) {
        ...
        // Ghost text acceptance can *technically* be acted upon in the command handler for "dwarf.logNextEditOutcomeAccept".
        ...
        const nextEditCompletionItem = new vscode.InlineCompletionItem(
          ...
          ),
          {
            ...
            command: "dwarf.logNextEditOutcomeAccept",
