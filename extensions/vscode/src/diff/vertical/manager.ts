...
export class VerticalDiffManager {
  ...
  async streamDiffLines(
    ...
    vscode.commands.executeCommand("setContext", "mango.diffVisible", true);
    ...
    vscode.commands.executeCommand("setContext", "mango.streamingDiff", true);
  ...
  async streamEdit({
    ...
    if (existingHandler) {
      ...
      // but extra delta was added for each line generated by Mango
      // Before adding this back, we need to distinguish between human and Mango
    ...
    try {
      ...
      if (abortController.signal.aborted) {
        void vscode.commands.executeCommand("mango.rejectDiff");
      }
