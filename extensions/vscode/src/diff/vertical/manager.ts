...
export class VerticalDiffManager {
  ...
  async streamDiffLines(
    ...
    vscode.commands.executeCommand("setContext", "dwarf.diffVisible", true);
    ...
    vscode.commands.executeCommand("setContext", "dwarf.streamingDiff", true);
  ...
  async streamEdit({
    ...
    if (existingHandler) {
      ...
      // but extra delta was added for each line generated by Dwarf
      // Before adding this back, we need to distinguish between human and Dwarf
    ...
    try {
      ...
      if (abortController.signal.aborted) {
        void vscode.commands.executeCommand("dwarf.rejectDiff");
      }
